                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="assets/images/logo4.png" height="101px" width="200px" align="left">
...
<?php endif; ?>
                ...
                <div class="col-lg-8">
                    <div class="main-banner header-text">
                        <div class="Modern-Slider">
                          ...
                          <div class="item">
                            <div class="img-fill">
                                <img src="assets/images/GRAND.jpg" alt="">
                            </div>
                          </div>
                          <!-- // Item -->
                          <!-- Item -->
                          ...
                          <div class="item">
                            <div class="img-fill">
                                <img src="assets/images/grand2.jpg" alt="">
                            </div>
                          </div>
                          <!-- // Item -->
                        </div>
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>About Us</h6>
                            <h2>Experience The Luxury Like Never Before</h2>
                        </div>
                        <p>Klassy Cafe is one of the best   with Bootstrap  framework. You can download and feel free to use this website template layout for your restaurant business. You are allowed to use this template for commercial purposes. <br><br>You are NOT allowed to redistribute the template ZIP file on any template donwnload website. Please contact us for more information.</p>
                        <div class="row">
                            <div class="col-4">
  ...
  <?php echo $__env->make("rooms", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- ***** Chefs Area Starts ***** -->
    <?php echo $__env->make("foodchef", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- ***** Chefs Area Ends ***** -->
...
</html><?php /**PATH C:\xampp\htdocs\Hotel-managent-booking-system\resources\views/home.blade.php ENDPATH**/ ?>