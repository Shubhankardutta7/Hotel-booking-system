      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="<?php echo e(url('/foodmenu')); ?>">
              ...
              <span class="menu-title">Hotel Rooms</span>
            </a>
          </li>
          <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="<?php echo e(url('/viewreservation')); ?>">
              ...
              <span class="menu-title">Reservations
       ...
       <?php /**PATH C:\xampp\htdocs\Hotel-managent-booking-system\resources\views/admin/navbar.blade.php ENDPATH**/ ?>